    ...
    $.fn.sSelect = function(options){
        return this.each(function(){
            ...
            var opts = $.extend(defaults, options),
                $input = $(this),
                //$containerDivText    = $('<div class="selectedTxt" tabindex="0"></div>'),
            ...
            $containerDivText.bind('click.sSelect',function(event){
                ...
                //show/hide this menu
                //$containerDivWrapper.toggle().parent().toggleClass('on');
            ...
            function closeDropDown(fireChange, resetText){
                ...
                $containerDivWrapper.hide().parent().removeClass('on');
                positionHideFix();
            }
            ...
            var $selCont = $(".selectBase .newListSelected, .selectBase .newListSelected");
            $selCont.each(function(){
                $(this).css("width",$(this).parent().find("select").outerWidth());
            });
